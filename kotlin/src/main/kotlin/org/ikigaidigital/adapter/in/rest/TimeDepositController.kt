...
class TimeDepositController(
    ...
    fun updateTimeDepositBalances(): UpdateTimeDepositBalancesResponse =
        TimeDepositResponseMapper.toResponse(updateTimeDepositBalancesUseCase.updateTimeDepositBalances())
}
